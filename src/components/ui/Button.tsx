...
const baseStyles =
  "inline-flex items-center justify-center gap-2 font-heading font-semibold leading-none rounded-full border-2 border-transparent cursor-pointer transition-all duration-150 ease-out disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none";
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  outline:
    "bg-transparent border-lagoon-500 text-lagoon-600 hover:bg-lagoon-50 focus-visible:ring-2 focus-visible:ring-lagoon-500 focus-visible:ring-offset-2",
  ghost:
